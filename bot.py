...
TOPIC_WORDS = {
    ...
    # РћС‚СЂР°СЃР»РµРІС‹Рµ С‚РµРјС‹
    "РЅРµС„С‚СЊ",
    "РЅРµС„С‚СЏРЅРѕР№",
    "РіР°Р·",
    "РіР°Р·РѕРІС‹Р№",
    "СЌРЅРµСЂРіРµС‚РёРєР°",
    "СЌРЅРµСЂРіРµС‚РёС‡РµСЃРєРёР№",
    "СЌР»РµРєС‚СЂРѕСЌРЅРµСЂРіРёСЏ",
    "РјРµС‚Р°Р»Р»СѓСЂРіРёСЏ",
    "РјРµС‚Р°Р»Р»",
    "СѓРіРѕР»СЊ",
    "РґРѕР±С‹С‡Р°",
    "СЃС‹СЂСЊРµ",
    "СЃС‚СЂРѕРёС‚РµР»СЊСЃС‚РІРѕ",
    "РЅРµРґРІРёР¶РёРјРѕСЃС‚СЊ",
    "РґРµРІРµР»РѕРїРµСЂ",
    "РґРµРІРµР»РѕРїРјРµРЅС‚",
    "Р°РІС‚РѕРјРѕР±РёР»Рё",
    "Р°РІС‚РѕРјРѕР±РёР»СЊРЅС‹Р№",
    "Р°РІС‚РѕРїСЂРѕРј",
    "Р°РІРёР°РєРѕРјРїР°РЅРёСЏ",
    "Р°РІРёР°С†РёСЏ",
    "СЃСѓРґРѕС…РѕРґСЃС‚РІРѕ",
    "РїРѕСЂС‚",
    "С„Р°СЂРјР°С†РµРІС‚РёРєР°",
    "РјРµРґРёС†РёРЅР°",
    "Р°РіСЂРѕР±РёР·РЅРµСЃ",
    "СЃРµР»СЊСЃРєРѕРµ С…РѕР·СЏР№СЃС‚РІРѕ",
    "РїСЂРѕРґРѕРІРѕР»СЊСЃС‚РІРёРµ",
    "e-commerce",
    "РјР°СЂРєРµС‚РїР»РµР№СЃ",
    "РјР°СЂРєРµС‚РїР»РµР№СЃС‹",
}
...
def article_is_relevant(article):
    ...
    # РСЃС‚РѕС‡РЅРёРєРё СѓР¶Рµ СЏРІР»СЏСЋС‚СЃСЏ СЂСѓСЃСЃРєРѕСЏР·С‹С‡РЅС‹РјРё RSS-Р»РµРЅС‚Р°РјРё.
    # РќРµ РѕС‚Р±СЂР°СЃС‹РІР°РµРј РЅРѕРІРѕСЃС‚СЊ РёР·-Р·Р° СЃРѕРѕС‚РЅРѕС€РµРЅРёСЏ РєРёСЂРёР»Р»РёС†С‹/Р»Р°С‚РёРЅРёС†С‹:
    # Р±СЂРµРЅРґС‹ Рё РєРѕРјРїР°РЅРёРё (Ozon, VK, Nvidia, Yandex Рё С‚.Рґ.) РјРѕРіСѓС‚ Р±С‹С‚СЊ Р»Р°С‚РёРЅРёС†РµР№.
    # Р”РѕРїРѕР»РЅРёС‚РµР»СЊРЅР°СЏ РїСЂРѕРІРµСЂРєР° СЏР·С‹РєР° Р·РґРµСЃСЊ РЅР°РјРµСЂРµРЅРЅРѕ РѕС‚РєР»СЋС‡РµРЅР°.

    # Р’ 6.6 С‚РµРјР°С‚РёС‡РµСЃРєРёР№ С„РёР»СЊС‚СЂ РќР• Р±Р»РѕРєРёСЂСѓРµС‚ РЅРѕРІРѕСЃС‚Рё.
    # RSS-Р»РµРЅС‚С‹ СѓР¶Рµ РїРѕРґРѕР±СЂР°РЅС‹ РїРѕРґ Р±РёР·РЅРµСЃ, СЌРєРѕРЅРѕРјРёРєСѓ Рё С‚РµС…РЅРѕР»РѕРіРёРё.
    # Р­С‚Рѕ СѓСЃС‚СЂР°РЅСЏРµС‚ Р»РѕР¶РЅС‹Рµ РѕС‚РєР°Р·С‹ РёР·-Р·Р° СЃРєР»РѕРЅРµРЅРёР№ СЃР»РѕРІ
    # (РЅР°РїСЂРёРјРµСЂ: "РЅРµС„С‚СЊ" -> "РЅРµС„С‚Рё", "РёРЅРІРµСЃС‚РёС†РёРё" -> "РёРЅРІРµСЃС‚РёС†РёР№").
    #
    # РћСЃС‚Р°РІР»СЏРµРј С‚РѕР»СЊРєРѕ СЏРІРЅС‹Р№ РјСѓСЃРѕСЂ, РµСЃР»Рё Р·Р°РіРѕР»РѕРІРѕРє С†РµР»РёРєРѕРј РѕС‚РЅРѕСЃРёС‚СЃСЏ
    # Рє СЂР°Р·РІР»РµРєР°С‚РµР»СЊРЅРѕР№/СЃРїРѕСЂС‚РёРІРЅРѕР№ С‚РµРјРµ.
    if contains_any(text, LOW_VALUE_WORDS):
        strong_business_hits = sum(
            1 for word in TOPIC_WORDS
            if word in text
        )
        if strong_business_hits == 0:
            print(f"  [FILTER] РЇРІРЅРѕ РЅРµ Р±РёР·РЅРµСЃ-С‚РµРјР°: {title}")
            return False
...
def quality_check(
    ...
    # RSS-РёСЃС‚РѕС‡РЅРёРєРё СѓР¶Рµ СЂСѓСЃСЃРєРѕСЏР·С‹С‡РЅС‹Рµ; РЅРµ Р±Р»РѕРєРёСЂСѓРµРј РїСѓР±Р»РёРєР°С†РёСЋ
    # РёР·-Р·Р° РЅР°Р·РІР°РЅРёР№ Р±СЂРµРЅРґРѕРІ Рё Р»Р°С‚РёРЅРёС†С‹.
    if len(post) > 4000:
        return False
...
def main():
    ...
    print(
        "РњР Рљ [Р‘РР—РќР•РЎ РќРћР’РћРЎРўР] вЂ” VERSION 6.6"
    )
